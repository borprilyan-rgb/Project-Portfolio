...
# --- ROW 1: cs1 to cs6 ---
    ...
    # --- TOTALS SUMMARY ---
            ...
            summary_val = "font-size: 28px; font-weight: bold; color: #000000; line-height: 1.2; margin-top: 5px;"
            ...
            st.markdown(f"""
                <div style="{summary_base} border-left: 12px solid #254E18; padding: 20px; background-color: #F5F7F5">
                    ...
                    <div style="font-size: 38px; font-weight: bold; color: #000000; line-height: 1.2; margin-top: 10px;">
