...
if st.button("Run Calculation", type="primary", use_container_width=True):
    ...
    t_precast = facade * f_recs[0]["Ratio"] * f_recs[0]["Rate"]
    t_window  = facade * f_recs[1]["Ratio"] * f_recs[1]["Rate"]
    t_double  = facade * f_recs[2]["Ratio"] * f_recs[2]["Rate"]
    ...
    f_mult = 1.32
    t_ht = gfa * fl_recs[0]["Ratio"] * fl_recs[0]["Rate"] * f_mult
    t_vinyl = gfa * fl_recs[1]["Ratio"] * fl_recs[1]["Rate"] * f_mult
    t_marmer = gfa * fl_recs[2]["Ratio"] * fl_recs[2]["Rate"] * f_mult
    ...
    hard_cost_data = {
        "Description": [
            ...
            "26. Glass Work", "27. FF&E", "28. Misc. (Linen/Gym)", "29. MEP Works", "30. External Works",
            "31. Public Facilities", "32. Resident Facilities", "33. Project Facilities", "34. Contingencies"
        ],
        "Basis": [
            ...
            f"{steel_door} units", "Ratio x 1.32", "Ratio x 1.32", "Ratio x 1.32", f"{carpet_m2} m2",
